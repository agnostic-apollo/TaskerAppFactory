 ...
 * https://cs.android.com/android/platform/superproject/+/android-12.0.0_r32:bionic/libc/include/paths.h;l=50
 * https://cs.android.com/android/_/android/platform/system/core/+/refs/tags/android-5.0.0_r1:rootdir/init.environ.rc.in;l=3
 */
public class AndroidShellEnvironment extends UnixShellEnvironment {
    private static final String LOG_TAG = "AndroidShellEnvironment";

    protected Context mCurrentPackageContext;

    public AndroidShellEnvironment(@NonNull Context currentPackageContext) {
        mCurrentPackageContext = currentPackageContext.getApplicationContext();
    }
    ...
    @NonNull
    @Override
    public HashMap<String, String> setupShellCommandEnvironment(@NonNull ExecutionCommand executionCommand) {
        Logger.logInfo(LOG_TAG, "time:start");

        HashMap<String, String> environment = getEnvironment(executionCommand.isFailsafe);
        Logger.logInfo(LOG_TAG, "time:end");
