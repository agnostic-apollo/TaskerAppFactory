package net.dinglisch.android.appfactory.utils.shell.runner.app;
...
import net.dinglisch.android.appfactory.R;
import net.dinglisch.android.appfactory.utils.data.DataUtils;
import net.dinglisch.android.appfactory.utils.errors.Errno;
...
import net.dinglisch.android.appfactory.utils.shell.ExecutionCommand.ExecutionState;
import net.dinglisch.android.appfactory.utils.shell.ShellUtils;
import net.dinglisch.android.appfactory.utils.shell.environment.IShellEnvironment;
import net.dinglisch.android.appfactory.utils.shell.StreamGobbler;
import net.dinglisch.android.appfactory.utils.shell.environment.ShellEnvironmentUtils;
import net.dinglisch.android.appfactory.utils.shell.result.ResultData;
...
public final class AppShell {
    ...
    public static AppShell execute(@NonNull final Context currentPackageContext, @NonNull ExecutionCommand executionCommand,
        ...
        HashMap<String, String> environment = shellEnvironmentClient.setupShellCommandEnvironment(executionCommand);
