...
public abstract class UnixShellEnvironment implements IShellEnvironment {
    ...
    @NonNull
    public abstract HashMap<String, String> getEnvironment(boolean isFailSafe);
    ...
    @NonNull
    @Override
    public abstract HashMap<String, String> setupShellCommandEnvironment(@NonNull ExecutionCommand executionCommand);
